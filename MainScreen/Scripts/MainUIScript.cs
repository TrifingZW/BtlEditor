...
public partial class MainUIScript : Control
{
    ...
    private void Start() => GetTree().ChangeSceneToFile("res://GameScreen/Game.tscn");
    ...
    private async Task LoadWc4Resource()
    {
        ...
        await Task.Run(() =>
        {
            ...
            try
            {
                ...
                CallDeferred(nameof(EnableButton));
            }
            catch (Exception e)
            {
    ...
    private void EnableButton() => GetNode<Button>("%StartButton").Disabled = false;
